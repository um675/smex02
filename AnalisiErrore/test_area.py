...
driver.Register()
pos01 = "U:/PaA/08_SMEX02/00_Input_data/Classificata"
os.chdir(pos01)
...
indlist=[indclass1,indclass2,indclass3,indclass4,indclass5,indclass6,indclass7,indclass8,indclass9,indclass10]
...
for k in range(0,(rasterfile_nbands)):
    ...
    for i in range(0,rasterfile.RasterYSize):
        for j in range(0,rasterfile.RasterXSize):
            ...
            print "iterazione ", nnn, "di ",rasterfile_3Darray.size



pos02 = "U:/PaA/08_SMEX02/03_Simulazioni/Landsat1j"
os.chdir(pos02)
